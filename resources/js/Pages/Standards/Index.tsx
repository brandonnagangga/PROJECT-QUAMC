    ...
    return (
        <AppLayout title="Standards" breadcrumb="Standards">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr', gap: 20 }}>
                <section style={{ background: '#fff', border: '1px solid #dde1ed', borderRadius: 14, padding: 22 }}>
                    <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 20, color: '#0f1f3d', marginBottom: 8 }}>
                        Reference Standards
                    </div>
                    <div style={{ fontSize: 12, color: '#4a5470', marginBottom: 18 }}>
                    ...
                    <form onSubmit={submit} style={{ display: 'grid', gap: 12 }}>
                        <input
                            ...
                            style={{ border: '1px solid #dde1ed', borderRadius: 8, padding: '10px 12px' }}
                        />
                        <input
                        ...
                        <textarea
                            ...
                            style={{ border: '1px solid #dde1ed', borderRadius: 8, padding: '10px 12px', minHeight: 90 }}
                        />
                        <select
                ...
                <section style={{ background: '#fff', border: '1px solid #dde1ed', borderRadius: 14, padding: 22 }}>
                    <div style={{ fontSize: 14, fontWeight: 700, color: '#0f1f3d', marginBottom: 14 }}>Indexed Standard Library</div>
                    <div style={{ display: 'grid', gap: 10 }}>
                        {standards.map((standard) => (
                            <div key={standard.id} style={{ border: '1px solid #eef1f7', borderRadius: 10, padding: 12 }}>
                        ...
                        {standards.length === 0 && (
                            <div style={{ fontSize: 12, color: '#8892aa' }}>No reference standards have been uploaded yet.</div>
                        )}
                    </div>
                </section>
            </div>
